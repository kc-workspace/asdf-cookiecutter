...
KC_ASDF_NAME="asdf-cookiecutter"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-cookiecutter"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="python"
KC_ASDF_APP_NAME="cookiecutter"
KC_ASDF_APP_WEBS="https://cookiecutter.readthedocs.io/en/stable/README.html"
KC_ASDF_APP_DESC=" command-line utility that creates projects from cookiecutters (project templates)."
KC_ASDF_APP_REPO="https://github.com/cookiecutter/cookiecutter"
